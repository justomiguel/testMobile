...
public class NotificationActionService extends CoreService {
    private final static String REPLY_ACTION = "com.jmv.frre.moduloestudiante.service.NotificationActionService.REPLY_ACTION";
    private final static String READ_ALL_ACTION = "com.jmv.frre.moduloestudiante.service.NotificationActionService.READ_ALL_ACTION";
    private final static String DELETE_ALL_ACTION = "com.jmv.frre.moduloestudiante.service.NotificationActionService.DELETE_ALL_ACTION";
    private final static String ACKNOWLEDGE_ACTION = "com.jmv.frre.moduloestudiante.service.NotificationActionService.ACKNOWLEDGE_ACTION";
