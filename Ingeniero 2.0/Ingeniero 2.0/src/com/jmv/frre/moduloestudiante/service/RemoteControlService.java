...
import com.jmv.frre.moduloestudiante.remotecontrol.K9RemoteControl;
...
import com.jmv.frre.moduloestudiante.K9.BACKGROUND_OPS;

import static com.jmv.frre.moduloestudiante.remotecontrol.K9RemoteControl.*;
...
public class RemoteControlService extends CoreService {
    private final static String RESCHEDULE_ACTION = "com.jmv.frre.moduloestudiante.service.RemoteControlService.RESCHEDULE_ACTION";
    private final static String PUSH_RESTART_ACTION = "com.jmv.frre.moduloestudiante.service.RemoteControlService.PUSH_RESTART_ACTION";

    private final static String SET_ACTION = "com.jmv.frre.moduloestudiante.service.RemoteControlService.SET_ACTION";
            ...
            execute(getApplication(), new Runnable() {
                public void run() {
                    try {
                        ...
                        if (needsReschedule) {
                            Intent i = new Intent();
                            i.setClassName(getApplication().getPackageName(), "com.jmv.frre.moduloestudiante.service.RemoteControlService");
