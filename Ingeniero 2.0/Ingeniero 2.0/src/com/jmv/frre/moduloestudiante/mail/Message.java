...
import com.jmv.frre.moduloestudiante.mail.filter.CountingOutputStream;
...
public abstract class Message implements Part, CompositeBody {
     ...
     * {@link com.jmv.frre.moduloestudiante.activity.MessageView.Listener#loadMessageForViewHeadersAvailable(com.jmv.frre.moduloestudiante.Account, String, String, Message)}
