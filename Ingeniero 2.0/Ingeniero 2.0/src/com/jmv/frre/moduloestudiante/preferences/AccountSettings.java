package com.jmv.frre.moduloestudiante.preferences;
...
import com.jmv.frre.moduloestudiante.preferences.Settings.*;
...
public class AccountSettings {
    ...
    static {
        ...
        s.put("ringtoneTimes", Settings.versions(
                new V(1, new StringResourceSetting("Always",
                        R.array.account_settings_ringtones_times_label))
        ));
        ...
        s.put("checkConnectivityTimes", Settings.versions(
                new V(1, new IntegerResourceSetting(1,
                R.array.account_settings_check_connectivity_times_label))
            ));
