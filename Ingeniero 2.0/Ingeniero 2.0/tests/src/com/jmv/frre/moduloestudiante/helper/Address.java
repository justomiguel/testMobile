...
public class Address extends TestCase {
    ...
    public void testParseWithMissingEmail() {
        com.jmv.frre.moduloestudiante.mail.Address[] addresses =  com.jmv.frre.moduloestudiante.mail.Address.parse("NAME ONLY");
    ...
    public void testPraseWithValidEmail() {
        com.jmv.frre.moduloestudiante.mail.Address[] addresses =  com.jmv.frre.moduloestudiante.mail.Address.parse("Max Mustermann <maxmuster@mann.com>");
        assertEquals(1, addresses.length);
    ...
    public void testPraseWithValidEmailMulti() {
        com.jmv.frre.moduloestudiante.mail.Address[] addresses =  com.jmv.frre.moduloestudiante.mail.Address.parse("lorem@ipsum.us,mark@twain.com");
