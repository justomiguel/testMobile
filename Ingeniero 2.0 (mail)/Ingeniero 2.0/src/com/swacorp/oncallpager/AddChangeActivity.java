...
public class AddChangeActivity extends Activity {
	...
	public static void showAddChangeActivityHome(Context context) {
		Intent intent = new Intent(context, AddChangeActivity.class);
	...
	protected TextView untilOutput;
	private TextView untilTimeOutput;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		untilTimeOutput = (TextView) findViewById(R.id.until_selected_time);
		...
		untilTimeOutput.setText(new StringBuilder().append(hourUntil)
				.append(":").append(minuteUntil));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.add_change, menu);
		return true;
	}
	...
	protected Dialog onCreateDialog(int id) {
		...
		case FROM_TIME_PICKER_ID:
			return new TimePickerDialog(this, fromTimePickerListener, hourFrom,
					minuteFrom,
					DateFormat.is24HourFormat(AddChangeActivity.this));
		case UNTIL_DATE_PICKER_ID:
			return new DatePickerDialog(this, untilPickerListener, yearUntil,
					monthUntil, dayUntil);
		case UNTIL_TIME__PICKER_ID:
			return new TimePickerDialog(this, untilTimePickerListener,
					hourUntil, minuteUntil,
					DateFormat.is24HourFormat(AddChangeActivity.this));
	...
	private TimePickerDialog.OnTimeSetListener untilTimePickerListener = new TimePickerDialog.OnTimeSetListener() {
