package com.jmv.frre.moduloestudiante.controller;
...
import com.jmv.frre.moduloestudiante.activity.FolderList;
import com.jmv.frre.moduloestudiante.activity.MessageList;
import com.jmv.frre.moduloestudiante.activity.MessageReference;
import com.jmv.frre.moduloestudiante.activity.NotificationDeleteConfirmation;
import com.jmv.frre.moduloestudiante.activity.setup.AccountSetupIncoming;
import com.jmv.frre.moduloestudiante.activity.setup.AccountSetupOutgoing;
import com.jmv.frre.moduloestudiante.cache.EmailProviderCache;
import com.jmv.frre.moduloestudiante.helper.Contacts;
import com.jmv.frre.moduloestudiante.helper.NotificationBuilder;
import com.jmv.frre.moduloestudiante.helper.power.TracingPowerManager;
import com.jmv.frre.moduloestudiante.helper.power.TracingPowerManager.TracingWakeLock;
import com.jmv.frre.moduloestudiante.mail.Address;
import com.jmv.frre.moduloestudiante.mail.FetchProfile;
import com.jmv.frre.moduloestudiante.mail.Flag;
import com.jmv.frre.moduloestudiante.mail.Folder;
import com.jmv.frre.moduloestudiante.mail.Folder.FolderType;

import com.jmv.frre.moduloestudiante.mail.Message;
import com.jmv.frre.moduloestudiante.mail.Message.RecipientType;
import com.jmv.frre.moduloestudiante.mail.CertificateValidationException;
import com.jmv.frre.moduloestudiante.mail.MessagingException;
import com.jmv.frre.moduloestudiante.mail.Part;
import com.jmv.frre.moduloestudiante.mail.PushReceiver;
import com.jmv.frre.moduloestudiante.mail.Pusher;
...
import com.jmv.frre.moduloestudiante.mail.store.LocalStore;
import com.jmv.frre.moduloestudiante.mail.store.LocalStore.LocalFolder;
import com.jmv.frre.moduloestudiante.mail.store.LocalStore.LocalMessage;
import com.jmv.frre.moduloestudiante.mail.store.LocalStore.PendingCommand;
import com.jmv.frre.moduloestudiante.mail.store.Pop3Store;
import com.jmv.frre.moduloestudiante.mail.store.UnavailableAccountException;
import com.jmv.frre.moduloestudiante.mail.store.UnavailableStorageException;
import com.jmv.frre.moduloestudiante.provider.EmailProvider;
import com.jmv.frre.moduloestudiante.provider.EmailProvider.StatsColumns;
import com.jmv.frre.moduloestudiante.search.ConditionsTreeNode;
import com.jmv.frre.moduloestudiante.search.LocalSearch;
import com.jmv.frre.moduloestudiante.search.SearchAccount;
import com.jmv.frre.moduloestudiante.search.SearchSpecification;
import com.jmv.frre.moduloestudiante.search.SqlQueryBuilder;
import com.jmv.frre.moduloestudiante.service.NotificationActionService;
...
public class MessagingController implements Runnable {
    ...
    private static final String PENDING_COMMAND_MOVE_OR_COPY = "com.jmv.frre.moduloestudiante.MessagingController.moveOrCopy";
    private static final String PENDING_COMMAND_MOVE_OR_COPY_BULK = "com.jmv.frre.moduloestudiante.MessagingController.moveOrCopyBulk";
    private static final String PENDING_COMMAND_MOVE_OR_COPY_BULK_NEW = "com.jmv.frre.moduloestudiante.MessagingController.moveOrCopyBulkNew";
    private static final String PENDING_COMMAND_EMPTY_TRASH = "com.jmv.frre.moduloestudiante.MessagingController.emptyTrash";
    private static final String PENDING_COMMAND_SET_FLAG_BULK = "com.jmv.frre.moduloestudiante.MessagingController.setFlagBulk";
    private static final String PENDING_COMMAND_SET_FLAG = "com.jmv.frre.moduloestudiante.MessagingController.setFlag";
    private static final String PENDING_COMMAND_APPEND = "com.jmv.frre.moduloestudiante.MessagingController.append";
    private static final String PENDING_COMMAND_MARK_ALL_AS_READ = "com.jmv.frre.moduloestudiante.MessagingController.markAllAsRead";
    private static final String PENDING_COMMAND_EXPUNGE = "com.jmv.frre.moduloestudiante.MessagingController.expunge";
    ...
    private void notifyAccountWithDataLocked(Context context, Account account,
        ...
        configureNotification(
                ...
                (n.isLed()) ? Integer.valueOf(n.getLedColor()) : Color.RED,
                K9.NOTIFICATION_LED_BLINK_SLOW,
                ringAndVibrate);

        Notification notif = builder.build();
        if (n.shouldKeepPlaying()){
