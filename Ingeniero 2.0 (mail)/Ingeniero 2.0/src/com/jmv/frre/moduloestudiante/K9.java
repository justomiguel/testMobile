...
import com.jmv.frre.moduloestudiante.Account.SortType;
import com.jmv.frre.moduloestudiante.activity.MessageCompose;
import com.jmv.frre.moduloestudiante.activity.UpgradeDatabases;
...
import com.jmv.frre.moduloestudiante.mail.internet.BinaryTempFileBody;
import com.jmv.frre.moduloestudiante.mail.store.LocalStore;
import com.jmv.frre.moduloestudiante.provider.UnreadWidgetProvider;
import com.jmv.frre.moduloestudiante.service.BootReceiver;
import com.jmv.frre.moduloestudiante.service.MailService;
import com.jmv.frre.moduloestudiante.service.ShutdownReceiver;
import com.jmv.frre.moduloestudiante.service.StorageGoneReceiver;
...
public class K9 extends Application {
    ...
    public static class Intents {
        ...
        public static class EmailReceived {
            public static final String ACTION_EMAIL_RECEIVED    = "com.jmv.frre.moduloestudiante.intent.action.EMAIL_RECEIVED";
            public static final String ACTION_EMAIL_DELETED     = "com.jmv.frre.moduloestudiante.intent.action.EMAIL_DELETED";
            public static final String ACTION_REFRESH_OBSERVER  = "com.jmv.frre.moduloestudiante.intent.action.REFRESH_OBSERVER";
            public static final String EXTRA_ACCOUNT            = "com.jmv.frre.moduloestudiante.intent.extra.ACCOUNT";
            public static final String EXTRA_FOLDER             = "com.jmv.frre.moduloestudiante.intent.extra.FOLDER";
            public static final String EXTRA_SENT_DATE          = "com.jmv.frre.moduloestudiante.intent.extra.SENT_DATE";
            public static final String EXTRA_FROM               = "com.jmv.frre.moduloestudiante.intent.extra.FROM";
            public static final String EXTRA_TO                 = "com.jmv.frre.moduloestudiante.intent.extra.TO";
            public static final String EXTRA_CC                 = "com.jmv.frre.moduloestudiante.intent.extra.CC";
            public static final String EXTRA_BCC                = "com.jmv.frre.moduloestudiante.intent.extra.BCC";
            public static final String EXTRA_SUBJECT            = "com.jmv.frre.moduloestudiante.intent.extra.SUBJECT";
            public static final String EXTRA_FROM_SELF          = "com.jmv.frre.moduloestudiante.intent.extra.FROM_SELF";
        }

        public static class Share {
            /*
             * We don't want to use EmailReceived.EXTRA_FROM ("com.jmv.frre.moduloestudiante.intent.extra.FROM")
             * because of different semantics (String array vs. string with comma separated
             * email addresses)
             */
            public static final String EXTRA_FROM               = "com.jmv.frre.moduloestudiante.intent.extra.SENDER";
        }
    }
