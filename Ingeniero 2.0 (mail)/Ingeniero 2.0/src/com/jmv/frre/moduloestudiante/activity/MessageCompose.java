...
import com.jmv.frre.moduloestudiante.Account.MessageFormat;
import com.jmv.frre.moduloestudiante.Account.QuoteStyle;
import com.jmv.frre.moduloestudiante.EmailAddressAdapter;
import com.jmv.frre.moduloestudiante.EmailAddressValidator;
import com.jmv.frre.moduloestudiante.FontSizes;
import com.jmv.frre.moduloestudiante.Identity;
...
import com.jmv.frre.moduloestudiante.activity.loader.AttachmentContentLoader;
import com.jmv.frre.moduloestudiante.activity.loader.AttachmentInfoLoader;
import com.jmv.frre.moduloestudiante.activity.misc.Attachment;
import com.jmv.frre.moduloestudiante.controller.MessagingController;
import com.jmv.frre.moduloestudiante.controller.MessagingListener;
import com.jmv.frre.moduloestudiante.crypto.CryptoProvider;
import com.jmv.frre.moduloestudiante.crypto.PgpData;
import com.jmv.frre.moduloestudiante.fragment.ProgressDialogFragment;
import com.jmv.frre.moduloestudiante.helper.ContactItem;
import com.jmv.frre.moduloestudiante.helper.Contacts;
import com.jmv.frre.moduloestudiante.helper.HtmlConverter;
import com.jmv.frre.moduloestudiante.helper.StringUtils;
import com.jmv.frre.moduloestudiante.helper.Utility;
import com.jmv.frre.moduloestudiante.mail.Address;
import com.jmv.frre.moduloestudiante.mail.Body;
import com.jmv.frre.moduloestudiante.mail.Flag;
import com.jmv.frre.moduloestudiante.mail.Message;
import com.jmv.frre.moduloestudiante.mail.Message.RecipientType;
import com.jmv.frre.moduloestudiante.mail.MessagingException;
import com.jmv.frre.moduloestudiante.mail.Multipart;
import com.jmv.frre.moduloestudiante.mail.Part;
import com.jmv.frre.moduloestudiante.mail.internet.MimeBodyPart;
import com.jmv.frre.moduloestudiante.mail.internet.MimeHeader;
import com.jmv.frre.moduloestudiante.mail.internet.MimeMessage;
import com.jmv.frre.moduloestudiante.mail.internet.MimeMultipart;
import com.jmv.frre.moduloestudiante.mail.internet.MimeUtility;
import com.jmv.frre.moduloestudiante.mail.internet.TextBody;
import com.jmv.frre.moduloestudiante.mail.store.LocalStore.LocalAttachmentBody;
import com.jmv.frre.moduloestudiante.mail.store.LocalStore.TempFileBody;
import com.jmv.frre.moduloestudiante.mail.store.LocalStore.TempFileMessageBody;
...
public class MessageCompose extends K9Activity implements OnClickListener,
    ...
    private static final String ACTION_COMPOSE = "com.jmv.frre.moduloestudiante.intent.action.COMPOSE";
    private static final String ACTION_REPLY = "com.jmv.frre.moduloestudiante.intent.action.REPLY";
    private static final String ACTION_REPLY_ALL = "com.jmv.frre.moduloestudiante.intent.action.REPLY_ALL";
    private static final String ACTION_FORWARD = "com.jmv.frre.moduloestudiante.intent.action.FORWARD";
    private static final String ACTION_EDIT_DRAFT = "com.jmv.frre.moduloestudiante.intent.action.EDIT_DRAFT";
    ...
    private static final String STATE_KEY_ATTACHMENTS =
        "com.jmv.frre.moduloestudiante.activity.MessageCompose.attachments";
    private static final String STATE_KEY_CC_SHOWN =
        "com.jmv.frre.moduloestudiante.activity.MessageCompose.ccShown";
    private static final String STATE_KEY_BCC_SHOWN =
        "com.jmv.frre.moduloestudiante.activity.MessageCompose.bccShown";
    private static final String STATE_KEY_QUOTED_TEXT_MODE =
        "com.jmv.frre.moduloestudiante.activity.MessageCompose.QuotedTextShown";
    private static final String STATE_KEY_SOURCE_MESSAGE_PROCED =
        "com.jmv.frre.moduloestudiante.activity.MessageCompose.stateKeySourceMessageProced";
    private static final String STATE_KEY_DRAFT_ID = "com.jmv.frre.moduloestudiante.activity.MessageCompose.draftId";
    private static final String STATE_KEY_HTML_QUOTE = "com.jmv.frre.moduloestudiante.activity.MessageCompose.HTMLQuote";
    private static final String STATE_IDENTITY_CHANGED =
        "com.jmv.frre.moduloestudiante.activity.MessageCompose.identityChanged";
    private static final String STATE_IDENTITY =
        "com.jmv.frre.moduloestudiante.activity.MessageCompose.identity";
    private static final String STATE_PGP_DATA = "pgpData";
    private static final String STATE_IN_REPLY_TO = "com.jmv.frre.moduloestudiante.activity.MessageCompose.inReplyTo";
    private static final String STATE_REFERENCES = "com.jmv.frre.moduloestudiante.activity.MessageCompose.references";
    private static final String STATE_KEY_READ_RECEIPT = "com.jmv.frre.moduloestudiante.activity.MessageCompose.messageReadReceipt";
    private static final String STATE_KEY_DRAFT_NEEDS_SAVING = "com.jmv.frre.moduloestudiante.activity.MessageCompose.mDraftNeedsSaving";
    private static final String STATE_KEY_FORCE_PLAIN_TEXT =
            "com.jmv.frre.moduloestudiante.activity.MessageCompose.forcePlainText";
    private static final String STATE_KEY_QUOTED_TEXT_FORMAT =
            "com.jmv.frre.moduloestudiante.activity.MessageCompose.quotedTextFormat";
