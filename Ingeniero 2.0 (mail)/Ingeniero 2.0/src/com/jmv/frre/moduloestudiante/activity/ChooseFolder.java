...
public class ChooseFolder extends K9ListActivity {
    public static final String EXTRA_ACCOUNT = "com.jmv.frre.moduloestudiante.ChooseFolder_account";
    public static final String EXTRA_CUR_FOLDER = "com.jmv.frre.moduloestudiante.ChooseFolder_curfolder";
    public static final String EXTRA_SEL_FOLDER = "com.jmv.frre.moduloestudiante.ChooseFolder_selfolder";
    public static final String EXTRA_NEW_FOLDER = "com.jmv.frre.moduloestudiante.ChooseFolder_newfolder";
    public static final String EXTRA_MESSAGE = "com.jmv.frre.moduloestudiante.ChooseFolder_message";
    public static final String EXTRA_SHOW_CURRENT = "com.jmv.frre.moduloestudiante.ChooseFolder_showcurrent";
    public static final String EXTRA_SHOW_FOLDER_NONE = "com.jmv.frre.moduloestudiante.ChooseFolder_showOptionNone";
    public static final String EXTRA_SHOW_DISPLAYABLE_ONLY = "com.jmv.frre.moduloestudiante.ChooseFolder_showDisplayableOnly";
