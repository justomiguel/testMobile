...
public class NotificationSetting {
    ...
    private int mCheckConnectivityTimes;
    ...
    public synchronized int getConnectivityTimesCheck() {
        return mCheckConnectivityTimes;
    }
    ...
    public synchronized void setConnectivityTimesCheck(int times) {
        mCheckConnectivityTimes = times;
    }
	...
	public synchronized void setKeepPlaying(boolean ring) {
        mKeepPlaying = ring;
    }

	public synchronized boolean shouldKeepPlaying() {
        return mKeepPlaying;
    }
